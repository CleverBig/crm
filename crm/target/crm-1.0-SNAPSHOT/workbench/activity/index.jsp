		...
		$("#addBtn").click(function(){
			...
			$.ajax({
				...
				success: function(data){
					$("#create-owner").append("<option value="+data.id+">"+data.name+"</option>");
				}
			})
		...
		$.ajax({
			...
			success: function(data){
				...
				$.each(data.dataList,function(i,v){
					$("#activityBody").append(
							'<tr class="active">'+
								'<td><input name="subSelect" type="checkbox" id="'+v.id+'" /></td>'+
								'<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'detail.html\';">'+v.name+'</a></td>'+
								'<td>'+v.owner+'</td>'+
								'<td>'+v.startDate+'</td>'+
								'<td>'+v.endDate+'</td>'+
							'</tr>'
